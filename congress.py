...
>>> def main():
...     age = int(input("Age?: "))
...     length = int(input("Citizenship length: "))
...     senator = False
...     citizen = False
...
...         print("wooo!! you are eligible for the house and senate")
...     elif citizen:
...         print("wooo!! you are eligible for the house")
...     else:
...         print("yikes you are ineligible for congress")
... 
...         
>>> main()
Enter age: 30
