...
...     win.yUp()
...     choicePairs = list()
...     buttonSetup = [(310, 350, 'orange'), (310, 310, 'pink'), (310, 270, 'blue'), (310, 320, 'purple')]
...     for (x, y, color) in buttonSetup:
...         button = makeColoredRect(Point(x, y), 80, 30, color, win)
...         choicePairs.append((button, color))
...         house = makeColoredRect(Point(60, 200), 180, 150, 'red', win)
...         door = makeColoredRect(Point(90, 150), 40, 100, 'green', win)
...         roof = Polygon(Point(50, 200), Point(250, 200), Point(150, 300))
...         chimne = makeColoredRect(Point(90, 335), 40, 60, 'black', win)
...         line = makeColoredRect(Point(105, 360), 5, 25, 'blue', win)
...         roof.draw(win)
